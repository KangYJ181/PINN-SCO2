...
pbounds = {'learning_rate': (0.0008, 0.0008), 'weight_decay': (4e-6, 4e-6), 'hidden_size':(14,14)}

'''
# Load optimizer state if it exists
if os.path.exists('optimizer_state_M1P2.pkl'):
    with open('optimizer_state_M1P2.pkl', 'rb') as f:
...
with open('optimizer_state_M1P2.pkl', 'wb') as f:
