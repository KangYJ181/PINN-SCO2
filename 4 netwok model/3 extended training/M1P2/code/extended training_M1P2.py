...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_D2M1P2.csv', index=False)



# Save model
torch.save(final_model.state_dict(), 'best M1P2 model_D2.pth')
...
coefficients_df.to_csv('optimized_coefficients_D2M1P2.csv', index=False)
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_D2M1P2.csv', index=False)
    ...
    upper_bound = error_line * 1.1
    lower_bound = error_line * 0.9
