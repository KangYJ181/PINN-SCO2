...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_DataDriven_D2.csv', index=False)
...
# Save model
torch.save(final_model.state_dict(), 'best data-driven model_D2.pth')
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_DataDriven_D2.csv', index=False)
    ...
    upper_bound = error_line * 1.5
    lower_bound = error_line * 0.65
