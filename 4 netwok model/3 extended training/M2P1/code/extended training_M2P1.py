...
hidden_size = 8
learning_rate = 0.000573377945408556
weight_decay = 0.0000183104735291918
...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_D2M2P1.csv', index=False)
...
# Save model
torch.save(final_model.state_dict(), 'best M2P1 model_D2.pth')
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_D2M2P1.csv', index=False)
