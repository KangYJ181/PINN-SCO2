...
hidden_size = 9
learning_rate = 0.00070406840138064
weight_decay = 0.0000313324282218724
...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_D2M2P2.csv', index=False)
...
# Save model
torch.save(final_model.state_dict(), 'best M2P2 model_D2.pth')
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_D2M2P2.csv', index=False)
