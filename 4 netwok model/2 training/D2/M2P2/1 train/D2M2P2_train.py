...
data = pd.read_csv('experimental data D2M2P2.csv')  # Load the data
...
if os.path.exists('optimizer_state_D2M2P2.pkl'):
    with open('optimizer_state_D2M2P2.pkl', 'rb') as f:
...
with open('optimizer_state_D2M2P2.pkl', 'wb') as f:
...
results_df.to_csv('optimization_results_D2M2P2.csv', index=False)
