...
pbounds = {'learning_rate': (0.0005, 0.001), 'weight_decay': (1e-5, 1e-4), 'hidden_size':(8,13)}
# Load optimizer state if it exists
if os.path.exists('optimizer_state_D1M2P2.pkl'):
    with open('optimizer_state_D1M2P2.pkl', 'rb') as f:
...
with open('optimizer_state_D1M2P2.pkl', 'wb') as f:
...
results_df.to_csv('optimization_results_D1M2P2.csv', index=False)
