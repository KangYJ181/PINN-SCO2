...
if os.path.exists('optimizer_state_D1M1P2.pkl'):
    with open('optimizer_state_D1M1P2.pkl', 'rb') as f:
...
with open('optimizer_state_D1M1P2.pkl', 'wb') as f:
...
results_df.to_csv('optimization_results_D1M1P2.csv', index=False)