...
if os.path.exists('optimizer_state_D1M2P1.pkl'):
    with open('optimizer_state_D1M2P1.pkl', 'rb') as f:
...
with open('optimizer_state_D1M2P1.pkl', 'wb') as f:
...
results_df.to_csv('optimization_results_D1M2P1.csv', index=False)
