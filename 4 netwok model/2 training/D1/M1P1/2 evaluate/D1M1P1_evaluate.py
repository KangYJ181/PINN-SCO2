...
learning_rate = 0.001
w_loss_weight1 = 0.0242797982827983
w_loss_weight2 = 0.287874478680464
...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_D1M1P1.csv', index=False)


# Save model
torch.save(final_model.state_dict(), 'best M1P1 model_D1.pth')
...
coefficients_df.to_csv('optimized_coefficients_D1M1P1.csv', index=False)
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_D1M1P1.csv', index=False)
