...
if os.path.exists('optimizer_state_DataDriven_D1.pkl'):
    with open('optimizer_state_DataDriven_D1.pkl', 'rb') as f:
...
with open('optimizer_state_DataDriven_D1.pkl', 'wb') as f:
...
results_df.to_csv('optimization_results_DataDriven_D1.csv', index=False)
