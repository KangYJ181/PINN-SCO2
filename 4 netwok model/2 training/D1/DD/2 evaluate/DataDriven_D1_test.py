...
hidden_size = 11
learning_rate = 0.00099866142522574
weight_decay = 0.0000255106457510795
...
for epoch in range(num_epochs):
    ...
    loss_df.to_csv('training_losses_DataDriven_D1.csv', index=False)
...
# Save model
torch.save(final_model.state_dict(), 'best data-driven model_D1.pth')
...
with torch.no_grad():
    ...
    results_df.to_csv('final_predictions_DataDriven_D1.csv', index=False)
